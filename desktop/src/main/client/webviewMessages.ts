// Copied from webviewMessages.ts in an earlier webview build of the VS Code extension (v0.4.0) with only
// the provenance header added — this file is otherwise verbatim and has no
// vscode/DOM dependency, so it ports to the Electron main process unchanged.
// Do not edit here to fix upstream bugs; sync from the extension instead.
