...
// the whole module runs in plain Node under scripts/test-client.js. The VS Code
// extension carries the same module at src/versionCheck.ts, identical apart from
...
export const PRODUCT_KEY = 'desktop';
