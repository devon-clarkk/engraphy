...
| | `type` | string | yes | registered node type name; the reserved `engram_sentinel` → `ENGRAPHY_VALIDATION` (ruled 2026-07-21 — applies to every write-pipeline entry point: `write`, `supersede`, import, promote) |
